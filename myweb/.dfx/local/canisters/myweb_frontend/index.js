...
import { idlFactory } from './myweb_frontend.did.js';
export { idlFactory } from './myweb_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYWEB_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./myweb_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the myweb_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./myweb_frontend.did.js")._SERVICE>}
 */
export const myweb_frontend = createActor(canisterId);
