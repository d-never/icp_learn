...
import { idlFactory } from './myweb_backend.did.js';
export { idlFactory } from './myweb_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYWEB_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./myweb_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the myweb_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./myweb_backend.did.js")._SERVICE>}
 */
export const myweb_backend = createActor(canisterId);
