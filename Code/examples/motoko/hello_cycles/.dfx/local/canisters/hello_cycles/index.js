...
import { idlFactory } from './hello_cycles.did.js';
export { idlFactory } from './hello_cycles.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HELLO_CYCLES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_cycles.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello_cycles canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_cycles.did.js")._SERVICE>}
 */
export const hello_cycles = createActor(canisterId);
