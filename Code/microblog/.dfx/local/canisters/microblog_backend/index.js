...
import { idlFactory } from './microblog_backend.did.js';
export { idlFactory } from './microblog_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MICROBLOG_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./microblog_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the microblog_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./microblog_backend.did.js")._SERVICE>}
 */
export const microblog_backend = createActor(canisterId);
