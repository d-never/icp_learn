...
import { idlFactory } from './microblog2.did.js';
export { idlFactory } from './microblog2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MICROBLOG2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./microblog2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the microblog2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./microblog2.did.js")._SERVICE>}
 */
export const microblog2 = createActor(canisterId);
