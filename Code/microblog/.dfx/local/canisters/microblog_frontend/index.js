...
import { idlFactory } from './microblog_frontend.did.js';
export { idlFactory } from './microblog_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MICROBLOG_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./microblog_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the microblog_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./microblog_frontend.did.js")._SERVICE>}
 */
export const microblog_frontend = createActor(canisterId);
