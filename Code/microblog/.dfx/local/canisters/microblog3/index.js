...
import { idlFactory } from './microblog3.did.js';
export { idlFactory } from './microblog3.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MICROBLOG3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./microblog3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the microblog3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./microblog3.did.js")._SERVICE>}
 */
export const microblog3 = createActor(canisterId);
